<aside id="cartbar" class="closecart h-[100dvh] xl:w-[30dvw] md:w-[50dvw] w-[90dvw] border-2  bg-white fixed z-50 top-0 right-0 rounded-l-xl p-5 pr-10 lg:pr-5">
    <div class="w-full h-full grid grid-rows-8 scroll-m-2">
        ...
        <div class="grid grid-flow-row row-span-5 gap-y-5 overflow-y-auto scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-slate-700 scrollbar-track-slate-300">
            <div class="cartProduct flex flex-row gap-x-2 h-36 w-full lg:px-5 border-b">
                <div class="p-1 max-w-1/3 relative">
                    <img src="https://i.pravatar.cc/" alt="Gambar Product" class="h-full w-32 object-center object-cover rounded-lg ">
                ...
                <div class="font-semibold font-sans py-2 gap-y-5 max-w-2/3">
        ...
        <div class="grid grid-cols-3 items-center px-10 gap-x-7 border-t">
            <div class="items-center"><h4 class="lg:text-2xl text-lg font-medium">Total :</h4></div>
            <div class="col-span-2 items-center text-right"><h4 class="lg:text-xl text-lg text-red-600 font-medium">Rp, 4,000,000</h4></div>
        </div>
        <div class="flex items-center justify-center px-10 gap-x-7 border-t">
            <button id="checkoutBtn" class="w-auto h-auto px-3 py-2 bg-blue-500 text-white font-poppins font-medium rounded-md hover:bg-white hover:ring-1 hover:ring-blue-500 hover:text-blue-500 duration-300 ease-in-out">Checkout</button>
        </div>
    </div>
</aside>