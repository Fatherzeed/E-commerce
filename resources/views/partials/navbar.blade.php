    ...
    <div class="nav-container wrapper80 flex lg:max-w-6xl h-14 mx-auto">
        <div class="content grid grid-cols-5 px-4 w-full">
            ...
            <div class="hidden md:flex col-span-3 items-center justify-center gap-x-10 w-full">
                ...
                <a href="{{ route('home') }}"
                    class="h-full hidden lg:flex items-center border-b-4 border-transparent hover:border-blue-600 font-poppins hover:scale-110 duration-300 hover:skew-x-10 ease-in-out">Home</a>
                <a href="#"
                    class="h-full flex items-center font-poppins border-b-4 border-transparent hover:border-blue-600 hover:scale-110 duration-300 hover:skew-x-10 ease-in-out">Categories</a>
            </div>
            ...
            <div class="hidden md:flex items-center lg:pl-10 pl-5">
                ...
                <div
                    ...
                    <button class="pl-1 font-poppins group-hover:text-blue-600 duration-300 ease-in-out">
                        {{ $username ?? '' }}
                    </button>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="absolute top-[105%] left-0 w-32 h-auto" id="dropdownContainer">
                        <ul class="flex flex-col items-center shadow-lg py-1 bg-red-500 rounded-b-lg">
                            <a class="w-full p-2 bg-blue-200" href="">
                                <li>Login</li>
                            </a>
                            <a class="w-full p-2 bg-blue-200" href="">
                                <li>My Profile</li>
