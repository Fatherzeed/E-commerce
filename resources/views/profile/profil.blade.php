...
@section('content')
    ...
    <section class="bg-blue-300 ">
        <div class="md:max-w-7xl max-w-full h-[100dvh] mx-auto bg-white flex gap-x-5 py-10">

            <div class="relative flex mx-auto md:w-2/3">
                    ...
                    <div class="w-full bg-white flex flex-between">
                        <div class="flex flex-col text-center text-[2rem] font-semibold shrink-0">
                            <div class="relative">
                                ...
                                <div class="absolute right-10 bottom-0 w-10 h-10 rounded-full flex items-center">
                                    <label for="userPicture" class="text-xs cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor"
                                            class="size-10 p-2 rounded-full border-2 border-black bg-gray-200">
                                    ...
                                    <input id="userPicture" name="userPicture" type="file" class="opacity-0"
                                        accept="image/*">
                                </div>
                            </div>
                            <h2>{{ $username }}</h2>
                        ...
                        <div class="pl-10 w-full">
                            ...
                            <button id="saveBtn"
                                class="mt-4 px-3 py-2 bg-blue-500 text-white rounded-md flex gap-x-1 hover:bg-white hover:text-blue-500 hover:ring-2 hover:ring-blue-500 duration-200 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
